package mc.garakrral.bettertp.client.toast;
...
public final class BetterTpToast implements Toast {
    ...
    private BetterTpToast(Component title, Component subtitle) {
        this.title = title;
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, Font font, long l) {
        ...
        graphics.text(font, title, 8, 7, 0xFFFFFF, false);
        graphics.text(font, subtitle, 8, 18, 0xB0B0B0, false);
